...
const SOURCE_TABLES: SourceTable[] = [
    ...
    table("msdyn_purchaseorder", "Purchase Order", "הזמנת רכש", [
        ...
        source("msdyn_totalamount", "Total amount", "סכום כולל", DATA_TYPE.money),
        source("msdyn_amountbilled", "Amount billed", "סכום שחויב", DATA_TYPE.money),
        source("msdyn_paymentterm", "Payment term", "תנאי תשלום", DATA_TYPE.lookup),
        source("msdyn_receivetowarehouse", "Receive to warehouse", "קבלה למחסן", DATA_TYPE.lookup),
        source("msdyn_podate", "Purchase order date", "תאריך הזמנת רכש", DATA_TYPE.dateTime),
        source("msdyn_dateexpected", "Expected date", "תאריך צפוי", DATA_TYPE.dateTime),
        source("msdyn_vendornote", "Vendor note", "הערת ספק", DATA_TYPE.text),
        source("transactioncurrencyid", "Currency", "מטבע", DATA_TYPE.lookup)
    ]),
    table("msdyn_purchaseorderproduct", "Purchase Order Product", "פריט הזמנת רכש", [
        source("msdyn_name", "Name", "שם", DATA_TYPE.text),
        source("msdyn_purchaseorderproductid", "Purchase order product ID", "מזהה פריט הזמנת רכש", DATA_TYPE.text),
        source("msdyn_purchaseorder", "Purchase order", "הזמנת רכש", DATA_TYPE.lookup),
        source("msdyn_product", "Product", "מוצר", DATA_TYPE.lookup),
        source("msdyn_description", "Description", "תיאור", DATA_TYPE.text),
        source("msdyn_quantity", "Quantity ordered", "כמות שהוזמנה", DATA_TYPE.decimal),
        source("msdyn_qtyreceived", "Quantity received", "כמות שהתקבלה", DATA_TYPE.decimal),
        source("msdyn_qtybilled", "Quantity billed", "כמות שחויבה", DATA_TYPE.decimal),
        source("msdyn_unit", "Unit", "יחידה", DATA_TYPE.lookup),
        source("msdyn_unitcost", "Unit cost", "עלות יחידה", DATA_TYPE.money),
        source("msdyn_totalcost", "Total cost", "עלות כוללת", DATA_TYPE.money),
        source("msdyn_itemstatus", "Item status", "מצב פריט", DATA_TYPE.choice),
        source("transactioncurrencyid", "Currency", "מטבע", DATA_TYPE.lookup)
    ]),
    table("msdyn_purchaseorderbill", "Purchase Order Bill", "חשבונית ספק להזמנת רכש", [
        source("msdyn_name", "Name", "שם", DATA_TYPE.text),
        source("msdyn_purchaseorderbillid", "Purchase order bill ID", "מזהה חשבונית ספק", DATA_TYPE.text),
        source("msdyn_purchaseorder", "Purchase order", "הזמנת רכש", DATA_TYPE.lookup),
        source("msdyn_billdate", "Bill date", "תאריך חשבונית", DATA_TYPE.dateTime),
        source("msdyn_vendorinvoicenumber", "Vendor invoice number", "מספר חשבונית ספק", DATA_TYPE.text),
        source("msdyn_subtotal", "Subtotal", "סכום ביניים", DATA_TYPE.money),
        source("msdyn_taxamount", "Tax amount", "סכום מס", DATA_TYPE.money),
        source("msdyn_shippingamount", "Shipping amount", "סכום משלוח", DATA_TYPE.money),
        source("msdyn_totalamount", "Total amount", "סכום כולל", DATA_TYPE.money),
        source("msdyn_paymentterm", "Payment term", "תנאי תשלום", DATA_TYPE.lookup),
        source("msdyn_taxcode", "Tax code", "קוד מס", DATA_TYPE.lookup),
        source("msdyn_note", "Note", "הערה", DATA_TYPE.text),
        source("transactioncurrencyid", "Currency", "מטבע", DATA_TYPE.lookup)
    ]),
    table("msdyn_purchaseorderreceipt", "Purchase Order Receipt", "קבלת הזמנת רכש", [
        source("msdyn_name", "Name", "שם", DATA_TYPE.text),
        source("msdyn_purchaseorderreceiptid", "Purchase order receipt ID", "מזהה קבלת רכש", DATA_TYPE.text),
        source("msdyn_purchaseorder", "Purchase order", "הזמנת רכש", DATA_TYPE.lookup),
        source("msdyn_datereceived", "Date received", "תאריך קבלה", DATA_TYPE.dateTime),
        source("msdyn_receivedby", "Received by", "התקבל על ידי", DATA_TYPE.lookup),
        source("msdyn_shipvia", "Ship via", "שיטת משלוח", DATA_TYPE.lookup),
        source("msdyn_note", "Note", "הערה", DATA_TYPE.text)
    ]),
    table("msdyn_purchaseorderreceiptproduct", "Purchase Order Receipt Product", "פריט קבלת רכש", [
        source("msdyn_name", "Name", "שם", DATA_TYPE.text),
        source("msdyn_purchaseorderreceiptproductid", "Purchase order receipt product ID", "מזהה פריט קבלת רכש", DATA_TYPE.text),
        source("msdyn_purchaseorder", "Purchase order", "הזמנת רכש", DATA_TYPE.lookup),
        source("msdyn_purchaseorderproduct", "Purchase order product", "פריט הזמנת רכש", DATA_TYPE.lookup),
        source("msdyn_purchaseorderreceipt", "Purchase order receipt", "קבלת רכש", DATA_TYPE.lookup),
        source("msdyn_associatetowarehouse", "Associate to warehouse", "שיוך למחסן", DATA_TYPE.lookup),
        source("msdyn_associatetoworkorder", "Associate to work order", "שיוך להזמנת עבודה", DATA_TYPE.lookup),
        source("msdyn_quantity", "Quantity received", "כמות שהתקבלה", DATA_TYPE.decimal),
        source("msdyn_unitcost", "Unit cost", "עלות יחידה", DATA_TYPE.money),
        source("msdyn_totalcost", "Total cost", "עלות כוללת", DATA_TYPE.money),
        source("transactioncurrencyid", "Currency", "מטבע", DATA_TYPE.lookup)
    ]),
    table("msdyn_workorder", "Work Order", "הזמנת עבודה", [
        source("msdyn_name", "Name", "שם", DATA_TYPE.text),
        source("msdyn_workorderid", "Work order ID", "מזהה הזמנת עבודה", DATA_TYPE.text),
        source("msdyn_billingaccount", "Billing account", "לקוח לחיוב", DATA_TYPE.lookup),
        source("msdyn_serviceaccount", "Service account", "לקוח שירות", DATA_TYPE.lookup),
        source("msdyn_subtotalamount", "Subtotal", "סכום ביניים", DATA_TYPE.money),
        source("msdyn_totalsalestax", "Sales tax", "מס מכירה", DATA_TYPE.money),
        source("msdyn_totalamount", "Total amount", "סכום כולל", DATA_TYPE.money),
        source("msdyn_systemstatus", "System status", "מצב מערכת", DATA_TYPE.choice),
        source("transactioncurrencyid", "Currency", "מטבע", DATA_TYPE.lookup)
    ]),
    table("msdyn_workorderproduct", "Work Order Product", "מוצר בהזמנת עבודה", [
        source("msdyn_name", "Name", "שם", DATA_TYPE.text),
        source("msdyn_workorderproductid", "Work order product ID", "מזהה מוצר בהזמנת עבודה", DATA_TYPE.text),
        source("msdyn_workorder", "Work order", "הזמנת עבודה", DATA_TYPE.lookup),
        source("msdyn_product", "Product", "מוצר", DATA_TYPE.lookup),
        source("msdyn_warehouse", "Warehouse", "מחסן", DATA_TYPE.lookup),
        source("msdyn_quantity", "Quantity", "כמות", DATA_TYPE.decimal),
        source("msdyn_qtytobill", "Quantity to bill", "כמות לחיוב", DATA_TYPE.decimal),
        source("msdyn_unit", "Unit", "יחידה", DATA_TYPE.lookup),
        source("msdyn_unitamount", "Unit amount", "מחיר יחידה", DATA_TYPE.money),
        source("msdyn_subtotal", "Subtotal", "סכום ביניים", DATA_TYPE.money),
        source("msdyn_totalamount", "Total amount", "סכום כולל", DATA_TYPE.money),
        source("msdyn_totalcost", "Total cost", "עלות כוללת", DATA_TYPE.money)
    ]),
    table("msdyn_inventoryjournal", "Inventory Journal", "יומן מלאי", [
        source("msdyn_name", "Name", "שם", DATA_TYPE.text),
        source("msdyn_inventoryjournalid", "Inventory journal ID", "מזהה יומן מלאי", DATA_TYPE.text),
        source("msdyn_product", "Product", "מוצר", DATA_TYPE.lookup),
        source("msdyn_warehouse", "Warehouse", "מחסן", DATA_TYPE.lookup),
        source("msdyn_quantity", "Quantity", "כמות", DATA_TYPE.decimal),
        source("msdyn_unit", "Unit", "יחידה", DATA_TYPE.lookup),
        source("msdyn_journaltype", "Journal type", "סוג יומן", DATA_TYPE.choice),
        source("msdyn_transactiontype", "Transaction type", "סוג תנועה", DATA_TYPE.choice),
        source("msdyn_purchaseorderproduct", "Purchase order product", "פריט הזמנת רכש", DATA_TYPE.lookup),
        source("msdyn_purchaseorderreceiptproduct", "Purchase order receipt product", "פריט קבלת רכש", DATA_TYPE.lookup),
        source("msdyn_workorderproduct", "Work order product", "מוצר בהזמנת עבודה", DATA_TYPE.lookup),
        source("msdyn_inventoryadjustmentproduct", "Inventory adjustment product", "פריט התאמת מלאי", DATA_TYPE.lookup),
        source("msdyn_allocatedtoworkorder", "Allocated to work order", "הוקצה להזמנת עבודה", DATA_TYPE.lookup)
    ]),
    table("msdyn_warehouse", "Warehouse", "מחסן", [
        source("msdyn_name", "Name", "שם", DATA_TYPE.text),
        source("msdyn_warehouseid", "Warehouse ID", "מזהה מחסן", DATA_TYPE.text),
        source("msdyn_description", "Description", "תיאור", DATA_TYPE.text),
        source("statecode", "Status", "מצב", DATA_TYPE.choice),
        source("statuscode", "Status reason", "סיבת מצב", DATA_TYPE.choice)
    ]),
    table("msdyn_productinventory", "Product Inventory", "מלאי מוצר", [
        source("msdyn_name", "Name", "שם", DATA_TYPE.text),
        source("msdyn_productinventoryid", "Product inventory ID", "מזהה מלאי מוצר", DATA_TYPE.text),
        source("msdyn_product", "Product", "מוצר", DATA_TYPE.lookup),
        source("msdyn_warehouse", "Warehouse", "מחסן", DATA_TYPE.lookup),
        source("msdyn_unit", "Unit", "יחידה", DATA_TYPE.lookup),
        source("msdyn_qtyonhand", "Quantity on hand", "כמות במלאי", DATA_TYPE.decimal),
        source("msdyn_qtyavailable", "Quantity available", "כמות זמינה", DATA_TYPE.decimal),
        source("msdyn_qtyallocated", "Quantity allocated", "כמות מוקצית", DATA_TYPE.decimal),
        source("msdyn_qtyonorder", "Quantity on order", "כמות בהזמנה", DATA_TYPE.decimal),
        source("msdyn_reorderpoint", "Reorder point", "נקודת הזמנה מחדש", DATA_TYPE.decimal),
        source("msdyn_bin", "Bin", "איתור", DATA_TYPE.text),
        source("msdyn_row", "Row", "שורה", DATA_TYPE.text)
    ]),
    table("msdyn_inventoryadjustment", "Inventory Adjustment", "התאמת מלאי", [
        source("msdyn_name", "Adjustment number", "מספר התאמה", DATA_TYPE.text),
        source("msdyn_inventoryadjustmentid", "Inventory adjustment ID", "מזהה התאמת מלאי", DATA_TYPE.text),
        source("msdyn_warehouse", "Warehouse", "מחסן", DATA_TYPE.lookup),
        source("msdyn_adjustmenttime", "Adjustment time", "מועד התאמה", DATA_TYPE.dateTime),
        source("msdyn_adjustedbyresource", "Adjusted by resource", "הותאם על ידי משאב", DATA_TYPE.lookup),
        source("msdyn_requestedbyresource", "Requested by resource", "התבקש על ידי משאב", DATA_TYPE.lookup),
        source("msdyn_description", "Description", "תיאור", DATA_TYPE.text)
    ]),
    table("msdyn_inventoryadjustmentproduct", "Inventory Adjustment Product", "פריט התאמת מלאי", [
        source("msdyn_name", "Name", "שם", DATA_TYPE.text),
        source("msdyn_inventoryadjustmentproductid", "Inventory adjustment product ID", "מזהה פריט התאמת מלאי", DATA_TYPE.text),
        source("msdyn_inventoryadjustment", "Inventory adjustment", "התאמת מלאי", DATA_TYPE.lookup),
        source("msdyn_inventorytransfer", "Inventory transfer", "העברת מלאי", DATA_TYPE.lookup),
        source("msdyn_product", "Product", "מוצר", DATA_TYPE.lookup),
        source("msdyn_quantity", "Quantity", "כמות", DATA_TYPE.decimal),
        source("msdyn_unit", "Unit", "יחידה", DATA_TYPE.lookup)
    ]),
    table("msdyn_inventorytransfer", "Inventory Transfer", "העברת מלאי", [
        source("msdyn_name", "Transfer number", "מספר העברה", DATA_TYPE.text),
        source("msdyn_inventorytransferid", "Inventory transfer ID", "מזהה העברת מלאי", DATA_TYPE.text),
        source("msdyn_sourcewarehouse", "Source warehouse", "מחסן מקור", DATA_TYPE.lookup),
        source("msdyn_destinationwarehouse", "Destination warehouse", "מחסן יעד", DATA_TYPE.lookup),
        source("msdyn_transfertime", "Transfer time", "מועד העברה", DATA_TYPE.dateTime),
        source("msdyn_transferredbyresource", "Transferred by resource", "הועבר על ידי משאב", DATA_TYPE.lookup),
        source("msdyn_description", "Description", "תיאור", DATA_TYPE.text)
    ]),
    table("msdyn_rtv", "Return to Vendor", "החזרה לספק", [
        source("msdyn_name", "RTV number", "מספר החזרה לספק", DATA_TYPE.text),
        source("msdyn_rtvid", "RTV ID", "מזהה החזרה לספק", DATA_TYPE.text),
        source("msdyn_vendor", "Vendor", "ספק", DATA_TYPE.lookup),
        source("msdyn_vendorcontact", "Vendor contact", "איש קשר ספק", DATA_TYPE.lookup),
        source("msdyn_vendorrma", "Vendor RMA", "RMA ספק", DATA_TYPE.text),
        source("msdyn_originalpurchaseorder", "Original purchase order", "הזמנת רכש מקורית", DATA_TYPE.lookup),
        source("msdyn_workorder", "Work order", "הזמנת עבודה", DATA_TYPE.lookup),
        source("msdyn_requestdate", "Request date", "תאריך בקשה", DATA_TYPE.dateTime),
        source("msdyn_returndate", "Return date", "תאריך החזרה", DATA_TYPE.dateTime),
        source("msdyn_totalamount", "Total credit amount", "סכום זיכוי כולל", DATA_TYPE.money),
        source("msdyn_taxcode", "Tax code", "קוד מס", DATA_TYPE.lookup),
        source("msdyn_systemstatus", "System status", "מצב מערכת", DATA_TYPE.choice),
        source("transactioncurrencyid", "Currency", "מטבע", DATA_TYPE.lookup)
    ]),
    table("msdyn_rtvproduct", "Return to Vendor Product", "פריט החזרה לספק", [
        source("msdyn_name", "Name", "שם", DATA_TYPE.text),
        source("msdyn_rtvproductid", "RTV product ID", "מזהה פריט החזרה לספק", DATA_TYPE.text),
        source("msdyn_rtv", "RTV", "החזרה לספק", DATA_TYPE.lookup),
        source("msdyn_product", "Product", "מוצר", DATA_TYPE.lookup),
        source("msdyn_description", "Description", "תיאור", DATA_TYPE.text),
        source("msdyn_quantity", "Quantity", "כמות", DATA_TYPE.decimal),
        source("msdyn_unit", "Unit", "יחידה", DATA_TYPE.lookup),
        source("msdyn_unitcreditamount", "Unit credit amount", "זיכוי ליחידה", DATA_TYPE.money),
        source("msdyn_totalcreditamount", "Total credit amount", "סכום זיכוי כולל", DATA_TYPE.money),
        source("msdyn_warehouse", "Warehouse", "מחסן", DATA_TYPE.lookup),
        source("msdyn_workorder", "Work order", "הזמנת עבודה", DATA_TYPE.lookup),
        source("transactioncurrencyid", "Currency", "מטבע", DATA_TYPE.lookup)
    ]),
...
const TARGETS: PayPlusTarget[] = [
    ...
    target(100000001, "Product", "מוצר", [
        ...
        ppField("name", "Product name", "שם מוצר", true, DATA_TYPE.text, { product: "name", productpricelevel: "product.name", msdyn_workorderproduct: "msdyn_product.name", msdyn_purchaseorderproduct: "msdyn_product.name", msdyn_productinventory: "msdyn_product.name", msdyn_inventoryjournal: "msdyn_product.name", msdyn_inventoryadjustmentproduct: "msdyn_product.name", msdyn_rtvproduct: "msdyn_product.name" }),
        ppField("price", "Price", "מחיר", true, DATA_TYPE.money, { product: "productpricelevel.amount", productpricelevel: "amount", msdyn_workorderproduct: "msdyn_unitamount", msdyn_purchaseorderproduct: "msdyn_unitcost", msdyn_purchaseorderreceiptproduct: "msdyn_unitcost", msdyn_rtvproduct: "msdyn_unitcreditamount" }),
        ppField("currency_code", "Currency", "מטבע", true, DATA_TYPE.text, { product: "transactioncurrencyid.isocurrencycode", productpricelevel: "transactioncurrencyid.isocurrencycode", msdyn_purchaseorderproduct: "transactioncurrencyid.isocurrencycode", msdyn_purchaseorderreceiptproduct: "transactioncurrencyid.isocurrencycode", msdyn_rtvproduct: "transactioncurrencyid.isocurrencycode" }),
        ppField("vat_type", "VAT type", "סוג מע\"מ", true, DATA_TYPE.number, {}),
        ppField("valid", "Valid", "פעיל", false, DATA_TYPE.boolean, { product: "statecode", msdyn_warehouse: "statecode" }),
        ppField("barcode", "Barcode", "ברקוד", false, DATA_TYPE.text, { product: "productnumber", productpricelevel: "product.productnumber", msdyn_workorderproduct: "msdyn_product.productnumber", msdyn_purchaseorderproduct: "msdyn_product.productnumber", msdyn_productinventory: "msdyn_product.productnumber", msdyn_inventoryjournal: "msdyn_product.productnumber", msdyn_inventoryadjustmentproduct: "msdyn_product.productnumber", msdyn_rtvproduct: "msdyn_product.productnumber" }),
        ppField("value", "Cost price", "מחיר עלות", false, DATA_TYPE.money, { product: "standardcost", msdyn_purchaseorderproduct: "msdyn_unitcost", msdyn_purchaseorderreceiptproduct: "msdyn_unitcost", msdyn_workorderproduct: "msdyn_totalcost", msdyn_rtvproduct: "msdyn_unitcreditamount" }),
        ppField("description", "Description", "תיאור", false, DATA_TYPE.text, { product: "description", productpricelevel: "product.name", msdyn_purchaseorderproduct: "msdyn_description", msdyn_rtvproduct: "msdyn_description", msdyn_warehouse: "msdyn_description", msdyn_inventoryadjustment: "msdyn_description", msdyn_inventorytransfer: "msdyn_description" }),
    ...
    target(100000008, "Purchase Order", "הזמנת רכש", documentTargetFields({ identifier: { msdyn_purchaseorder: "msdyn_purchaseorderid", msdyn_purchaseorderproduct: "msdyn_purchaseorderproductid", msdyn_purchaseorderreceipt: "msdyn_purchaseorderreceiptid", msdyn_purchaseorderreceiptproduct: "msdyn_purchaseorderreceiptproductid", msdyn_purchaseorderbill: "msdyn_purchaseorderbillid", msdyn_rtv: "msdyn_rtvid", msdyn_rtvproduct: "msdyn_rtvproductid" }, docDate: { msdyn_purchaseorder: "msdyn_podate", msdyn_purchaseorderreceipt: "msdyn_datereceived", msdyn_purchaseorderbill: "msdyn_billdate", msdyn_rtv: "msdyn_requestdate" }, moreInfo: { msdyn_purchaseorder: "msdyn_name", msdyn_purchaseorderproduct: "msdyn_name", msdyn_purchaseorderreceipt: "msdyn_name", msdyn_purchaseorderreceiptproduct: "msdyn_name", msdyn_purchaseorderbill: "msdyn_vendorinvoicenumber", msdyn_rtv: "msdyn_name", msdyn_rtvproduct: "msdyn_name" }, amount: { msdyn_purchaseorder: "msdyn_totalamount", msdyn_purchaseorderproduct: "msdyn_totalcost", msdyn_purchaseorderreceiptproduct: "msdyn_totalcost", msdyn_purchaseorderbill: "msdyn_totalamount", msdyn_rtv: "msdyn_totalamount", msdyn_rtvproduct: "msdyn_totalcreditamount" }, currency: { msdyn_purchaseorder: "transactioncurrencyid", msdyn_purchaseorderproduct: "transactioncurrencyid", msdyn_purchaseorderreceiptproduct: "transactioncurrencyid", msdyn_purchaseorderbill: "transactioncurrencyid", msdyn_rtv: "transactioncurrencyid", msdyn_rtvproduct: "transactioncurrencyid" }, customerUid: { msdyn_purchaseorder: "msdyn_vendor", msdyn_rtv: "msdyn_vendor" }, customerName: { msdyn_purchaseorder: "msdyn_vendor", msdyn_rtv: "msdyn_vendor" }, description: { msdyn_purchaseorder: "msdyn_vendornote", msdyn_purchaseorderproduct: "msdyn_description", msdyn_purchaseorderreceipt: "msdyn_note", msdyn_purchaseorderbill: "msdyn_note", msdyn_rtv: "msdyn_vendorrma", msdyn_rtvproduct: "msdyn_description" } }), { advanced: true }),
    ...
    target(100000026, "Invoice+ Expense", "הוצאה Invoice+", [
        ...
        ppField("supplier_vat_id", "Supplier VAT ID", "מספר עוסק ספק", false, DATA_TYPE.number, {}),
        ppField("number", "Document number", "מספר מסמך", true, DATA_TYPE.text, { msdyn_purchaseorder: "msdyn_name", msdyn_purchaseorderbill: "msdyn_vendorinvoicenumber", msdyn_purchaseorderreceipt: "msdyn_name", msdyn_rtv: "msdyn_name" }),
        ppField("doc_date", "Document date", "תאריך מסמך", true, DATA_TYPE.dateTime, { msdyn_purchaseorder: "msdyn_podate", msdyn_purchaseorderbill: "msdyn_billdate", msdyn_purchaseorderreceipt: "msdyn_datereceived", msdyn_rtv: "msdyn_requestdate" }),
        ppField("subcategory_id", "Subcategory ID", "מזהה תת קטגוריה", true, DATA_TYPE.number, {}),
        ppField("amount", "Amount", "סכום", true, DATA_TYPE.money, { msdyn_purchaseorder: "msdyn_totalamount", msdyn_purchaseorderproduct: "msdyn_totalcost", msdyn_purchaseorderbill: "msdyn_totalamount", msdyn_purchaseorderreceiptproduct: "msdyn_totalcost", msdyn_rtv: "msdyn_totalamount", msdyn_rtvproduct: "msdyn_totalcreditamount" }),
        ppField("amount_includes_vat", "Amount includes VAT", "הסכום כולל מע\"מ", false, DATA_TYPE.boolean, {}),
        ppField("vat_percentage", "VAT percentage", "אחוז מע\"מ", false, DATA_TYPE.decimal, {}),
        ppField("description", "Description", "תיאור", true, DATA_TYPE.text, { msdyn_purchaseorder: "msdyn_vendornote", msdyn_purchaseorderproduct: "msdyn_description", msdyn_purchaseorderbill: "msdyn_note", msdyn_purchaseorderreceipt: "msdyn_note", msdyn_rtv: "msdyn_vendorrma", msdyn_rtvproduct: "msdyn_description" }),
        ppField("currency_code", "Currency", "מטבע", true, DATA_TYPE.text, { msdyn_purchaseorder: "transactioncurrencyid", msdyn_purchaseorderproduct: "transactioncurrencyid", msdyn_purchaseorderbill: "transactioncurrencyid", msdyn_purchaseorderreceiptproduct: "transactioncurrencyid", msdyn_rtv: "transactioncurrencyid", msdyn_rtvproduct: "transactioncurrencyid" }),
        ppField("supplier_name", "Supplier", "ספק", false, DATA_TYPE.text, { msdyn_purchaseorder: "msdyn_vendor", msdyn_rtv: "msdyn_vendor" }),
        ppField("supplier_uid", "Supplier UID", "מזהה ספק", false, DATA_TYPE.text, { msdyn_purchaseorder: "msdyn_vendor", msdyn_rtv: "msdyn_vendor" }),
        ppField("doc_file", "Document file", "קובץ מסמך", false, DATA_TYPE.text, {})
    ], { hidden: true }),
    target(100000027, "Invoice+ Document", "מסמך Invoice+", [
        ppField("doc_type", "Document type", "סוג מסמך", true, DATA_TYPE.text, {}),
        ppField("customer_uid", "Customer UID", "מזהה לקוח", false, DATA_TYPE.text, { account: "alex_paypluscustomeruid", contact: "alex_paypluscustomeruid", msdyn_workorder: "msdyn_billingaccount", msdyn_purchaseorder: "msdyn_vendor", msdyn_rtv: "msdyn_vendor" }),
        ppField("document_number", "Document number", "מספר מסמך", false, DATA_TYPE.text, { invoice: "invoicenumber", quote: "quotenumber", salesorder: "ordernumber", msdyn_workorder: "msdyn_name", msdyn_purchaseorder: "msdyn_name", msdyn_purchaseorderbill: "msdyn_vendorinvoicenumber", msdyn_rtv: "msdyn_name" }),
        ppField("amount", "Amount", "סכום", true, DATA_TYPE.money, { invoice: "totalamount", quote: "totalamount", salesorder: "totalamount", msdyn_workorder: "msdyn_totalamount", msdyn_workorderproduct: "msdyn_totalamount", msdyn_purchaseorder: "msdyn_totalamount", msdyn_purchaseorderbill: "msdyn_totalamount", msdyn_rtv: "msdyn_totalamount" }),
        ppField("currency_code", "Currency", "מטבע", true, DATA_TYPE.text, { invoice: "transactioncurrencyid", quote: "transactioncurrencyid", salesorder: "transactioncurrencyid", msdyn_workorder: "transactioncurrencyid", msdyn_purchaseorder: "transactioncurrencyid", msdyn_purchaseorderbill: "transactioncurrencyid", msdyn_rtv: "transactioncurrencyid" })
    ], { hidden: true }),
...
function paymentRequestTargetFields(): PayPlusField[] {
    return [
        ...
        ppField("amount", "Amount", "סכום", true, DATA_TYPE.money, { invoice: "totalamount", quote: "totalamount", salesorder: "totalamount", opportunity: "estimatedvalue", msdyn_workorder: "msdyn_totalamount", msdyn_purchaseorder: "msdyn_totalamount", msdyn_rtv: "msdyn_totalamount" }),
        ppField("currency_code", "Currency", "מטבע", true, DATA_TYPE.text, { invoice: "transactioncurrencyid", quote: "transactioncurrencyid", salesorder: "transactioncurrencyid", msdyn_workorder: "transactioncurrencyid", msdyn_purchaseorder: "transactioncurrencyid", msdyn_rtv: "transactioncurrencyid" }),
        ppField("more_info", "More info", "מידע נוסף", false, DATA_TYPE.text, { invoice: "invoiceid", quote: "quoteid", salesorder: "salesorderid", msdyn_workorder: "msdyn_workorderid", msdyn_purchaseorder: "msdyn_purchaseorderid", msdyn_rtv: "msdyn_rtvid" }),
